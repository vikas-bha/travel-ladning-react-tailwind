...
const ImageSlider = () => {
  ...
  return (
    <div className='max-w-[1400px] h-[508px] w-full m-auto py-16 px-4 relative group'>
        ...
        {/* left arrow */}
        <div className='absolute top-[50%] -translate-x-0 -transalte-y-[-50%] left-5 text-2xl rounded-full p-2 group-hover:bg-black/20 text-white cursor-pointer'>

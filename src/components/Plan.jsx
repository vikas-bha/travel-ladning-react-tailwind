  ...
  return (
   <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4'>
    ...
    <div className='flex flex-col h-full justify-center'>
        ...
        <p className='text-2xl py-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, odio.</p>
        <p className='pb-6'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Placeat, quo adipisci? Recusandae, sapiente minima voluptatibus unde nisi tempora consectetur possimus exercitationem ab provident eveniet culpa tenetur alias eum suscipit mollitia.</p>
        <div>
